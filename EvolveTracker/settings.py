"""
Django settings for EvolveTracker project.
...
SECRET_KEY = 'o4w=l2+_5#lv%py7ac7i%%7a1j32_g70ljwbijxwk!+fznmb%z'
...
ROOT_URLCONF = 'EvolveTracker.urls'
...
WSGI_APPLICATION = 'EvolveTracker.wsgi.application'
